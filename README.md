...
<div align="center">
  ...
  <a class="header-badge" target="_blank" href="https://www.linkedin.com/in/hesham-al-saqqaf/">
  <img src="https://img.shields.io/badge/style--5eba00.svg?label=LinkedIn&logo=linkedin&style=social">
  </a>
  <a class="header-badge" target="_blank" href="https://twitter.com/hm_alsaqqaf2">
  <img alt="Twitter Follow" src="https://img.shields.io/twitter/follow/Hesham?style=social">
  </a>

<sub>Author:
<a href="https://www.linkedin.com/in/hesham-al-saqqaf/" target="_blank">Hesham Alsaqqaf</a><br>
<small> First Edition: July, 2024</small>
</sub>
</div>
...
['Yemen','Estonia', 'Sweden','KSA'] # all the same data types - a list of strings (countries)
...
```py
('Hesham', 'Pawel', 'Brook', 'Abraham', 'Lidiya') # Names
```
...
print(type('Hesham'))  # String
print(type([1, 2, 3]))   # List
print(type({'name':'Hesham'})) # Dictionary
